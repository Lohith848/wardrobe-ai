      ...
      <div style={{
        ...
        <div style={{ width: '100%', maxWidth: 380 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 20 }}>
            ...
            {/* Google */}
            <button onClick={() => handleSocial('google')} disabled={!!loading} style={{
              display: 'flex', alignItems: 'center', justifyContent: 'center',
            ...
            {/* Apple */}
            <button onClick={() => handleSocial('apple')} disabled={!!loading} style={{
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              gap: 12, width: '100%', padding: '13px 20px',
            ...
            {/* Microsoft */}
            <button onClick={() => handleSocial('microsoft')} disabled={!!loading} style={{
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              gap: 12, width: '100%', padding: '13px 20px',
              background: '#fff', border: '1px solid #e0e0e0',
              borderRadius: 10, cursor: 'pointer', fontSize: 15,
